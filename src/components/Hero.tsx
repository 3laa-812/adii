  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 text-center animate-fade-in">
        ...
        {/* Stats */}
        <div className="mt-16 mb-4 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto animate-slide-up [animation-delay:600ms]">
          <div className="bg-gradient-card p-6 rounded-xl shadow-card backdrop-blur-md hover:shadow-soft transition-all duration-300 hover:-translate-y-3 animate-fade-in">
            <div className="text-2xl font-bold text-primary mb-2">500K+</div>
            <div className="text-primary-500">Active Users</div>
          </div>
          <div className="bg-gradient-card p-6 rounded-xl shadow-card backdrop-blur-md hover:shadow-soft transition-all duration-300 hover:-translate-y-3 animate-fade-in">
            <div className="text-2xl font-bold text-success mb-2">99.9%</div>
            <div className="text-success-500">Uptime</div>
          </div>
          <div className="bg-gradient-card p-6 rounded-xl shadow-card backdrop-blur-md hover:shadow-soft transition-all duration-300 hover:-translate-y-3 animate-fade-in">
            <div className="text-2xl font-bold text-toll-gate mb-2">150+</div>
            <div className="text-toll-gate">Toll Gates</div>
          </div>
        </div>
      </div>
    </section>
